...
class Goose(Animal, Walking, Swimming):
    ...
    # run is defined in the Walking parent class, but also here. 
    # This run method will take precedence and Walking's run method will not be called by Goose instances
    def run(self):
